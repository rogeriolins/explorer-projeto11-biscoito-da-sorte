...
const phraseGoodLuck = document.querySelector("#phraseGoodLuck")
const cookieLuck = document.querySelector("#cookieLuck")
const newCookieBtn = document.querySelector("#newCookieBtn")
let thePhrase = phraseGoodLuck.querySelector("p")
let randomPhraseNumber = ""

// Events
cookieLuck.addEventListener("click", handleClickCookie)
newCookieBtn.addEventListener("click", handleResetCookie)

// Functions
function handleResetCookie(event) {
  event.preventDefault()
  thePhrase.innerText = phrase[randomPhraseNumber]
  phraseToggle()
  randomPhraseNumber = newPhrase()
}

function handleClickCookie(event) {
  randomPhraseNumber = newPhrase()
  thePhrase.innerText = phrase[randomPhraseNumber]
  phraseToggle()
}
...
function phraseToggle() {
  goodLuck.classList.toggle("hide")
  phraseGoodLuck.classList.toggle("hide")
}
